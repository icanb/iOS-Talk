...
- (void)insertNewObject:(id)sender
{
    ...
    [workshops insertObject:[[WorkshopDetail alloc] initWithTitle:@"Interface Design" description:@"Join us" date:@"Sunday"] atIndex:0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  WorkshopDetail *workshop  =[workshops objectAtIndex:indexPath.row];
